  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      cmp.setup {
        ...
        -- Don't select an item by default, requires noselect on completeopt,
        -- and select = false on confirm mapping for Enter
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- Close completion menu without leaving insert mode
